...
public class XtomFileDownLoader extends XtomObject {
	...
	private int threadCount = 1;// 异步线程数
	...
	private static class EventHandler extends android.os.Handler {
		...
		public void handleMessage(Message msg) {
			XtomDownLoadListener listener = downLoader
					.getXtomDownLoadListener();
			if (listener != null)
				switch (msg.what) {
				case START:
	...
	public XtomDownLoadListener getXtomDownLoadListener() {
		return xtomDownLoadListener;
	}

	public void setXtomDownLoadListener(
			XtomDownLoadListener xtomDownLoadListener) {
